  ...
  head: () => ({
    meta: [
      { title: "Log in — Reklama.uz" },
      {
        name: "description",
        content:
          "Log in or create your Reklama.uz account to book creator advertising.",
      },
    ],
  }),
  component: Auth,
...
function Auth() {
  ...
  const [submitted, setSubmitted] = useState<"email" | "google" | null>(null);
      ...
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-[2rem] border border-border bg-card shadow-lift lg:grid-cols-[1fr_1.1fr]">
        <section className="relative hidden overflow-hidden bg-foreground p-10 text-background lg:flex lg:flex-col">
          ...
          <div className="relative my-auto max-w-md">
            ...
            <p className="mt-4 text-base leading-relaxed text-background/70">
              Compare clear packages, real availability and audience data in one
              place.
            </p>
        ...
        <section className="flex flex-col p-6 sm:p-10 lg:p-14">
          ...
          <div className="mx-auto my-auto w-full max-w-md py-10 lg:py-0">
            <div className="rounded-xl bg-muted p-1">
              <div className="grid grid-cols-2 gap-1">
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-sm font-semibold transition-colors ${!isSignup ? "bg-card shadow-soft" : "text-muted-foreground hover:text-foreground"}`}
                >
                  Log in
                </button>
                <button
            ...
            {submitted ? (
              <div className="mt-7 rounded-2xl border border-primary/20 bg-accent p-5">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  This frontend flow is ready to connect to your authentication
                  provider.
                </p>
              </div>
            ) : (
